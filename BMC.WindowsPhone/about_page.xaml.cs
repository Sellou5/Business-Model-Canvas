...
namespace BMC
{
    ...
    public sealed partial class about_page : Page
    {
        ...
        private void DataRequested(DataTransferManager sender, DataRequestedEventArgs e)
        {
            ...
            request.Data.Properties.Title = "Business Model Canvas";
            request.Data.Properties.Description = "An example of how to share text.";
            request.Data.SetText("This application helps you to understand what is Business Model Canvas and it's all steps and it also enables you to make your Business Model canvas");
        }
        ...
        private async void AppBarButton_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            mail.Subject = "Business Model Canvas Feedback";
